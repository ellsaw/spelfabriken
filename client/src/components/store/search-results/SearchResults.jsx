 ...
 return (
    <section className="min-h-screen">
      ...
      <>
        {products.length > 0 ? 
        <>
             <h2 className="text-lg font-bold">Visar resultat för {query}</h2>
             <p className="font-semibold mt-golden-md">{products.length} {products.length === 1 ? "produkt" : "produkter"}</p>
        </>
         :
        <div className="flex flex-col items-center gap-golden-lg my-golden-xl">
            <h2 className="text-lg font-semibold">Hittade inga resultat för {query}</h2>
