...
export default function HeroItem({ img, text, buttonlabel, href, invisibleText }) {
 return (
        <div className={`bg-cover bg-center h-full w-screen max-w-[1024px] text-white flex justify-center items-end py-golden-2xl select-none`} style={{backgroundImage: `url(${img}`}}>
